...
import os
# Import spacer modules from spacer/
import spacer
...
# Module Directory is a local directory for pyspacer where secrets.json, images, 
module_dir = Path(__name__).resolve().parent
...
if __name__ == '__main__':
    ...
    for page in paginator.paginate(Bucket=bucketname):
        for obj in page.get('Contents', []):
            ...
            # Download the file
                s3_client.download_file(bucketname, obj['Key'], str(local_file_path))
